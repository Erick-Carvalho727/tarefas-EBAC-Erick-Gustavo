...
<html>
	<head>
		...
		<title><s:text name="label.titulo.pagina.editarfunc"/></title>
				...
				<div class="card mt-5">
					...
					<div class="card-body">
						<div class="row align-items-center">
							...
							<div class="col-sm-2">
								<s:textfield cssClass="form-control" id="id" name="funcionarioVo.rowidFunc" readonly="true"/>							
							</div>	
						</div>
						...
						<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:textfield cssClass="form-control" id="nome" name="funcionarioVo.nomeF"/>							
							</div>	
						</div>
					</div>
