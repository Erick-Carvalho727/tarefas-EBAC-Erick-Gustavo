...
<html>
	<head>
		...
		<title><s:text name="label.titulo.pagina.editexafunc"/></title>
		<link rel='stylesheet' href='webjars/bootstrap/5.1.3/css/bootstrap.min.css'>
	</head>
	<body class="bg-secondary">

		<div class="container">
			<s:form action="/editarExamesFunc.action">
				...
				<div class="card mt-5">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-sm">
								<h5 class="card-title">Editar exame realizado pelo funcionario</h5>
							</div>
						</div>
					</div>
